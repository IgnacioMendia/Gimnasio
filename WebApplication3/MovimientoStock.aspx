    ...
    <table style="width: 100%; height: 295px;">
        <tr>
            ...
            <td style="height: 20px; width: 311px">
                ...
                <asp:TextBox ID="txtStock" runat="server" Enabled="False" style="margin-left: 0px" CssClass="form-control" Width="150px" Height="23px"></asp:TextBox>
                <br />
                <asp:Label ID="Label2" runat="server" Text="Cantidad:" ForeColor="#FF3300"></asp:Label>
                <asp:TextBox ID="txtCantidad" runat="server" Enabled="False" style="margin-left: 0px" CssClass="form-control" Width="150px" Height="23px"></asp:TextBox>
                <br />
                <asp:Label ID="Label4" runat="server" Text="Precio unitario:" ForeColor="#FF3300"></asp:Label>
                <asp:TextBox ID="txtPrecioUnitario" runat="server" style="margin-left: 0px" Enabled="False" CssClass="form-control" Width="150px" Height="23px"></asp:TextBox>
                <br />
                <asp:Label ID="lblPrecioFinal" runat="server" Text="Precio final:" ForeColor="#FF3300"></asp:Label>
                <asp:TextBox ID="txtPrecioFinal" runat="server" Enabled="False" style="margin-left: 0px; margin-top: 0" CssClass="form-control" Width="150px" Height="23px"></asp:TextBox>
                <br />

                <asp:Label ID="lblCliente" runat="server" Text="Cliente:                              " ForeColor="#FF3300"></asp:Label>
                <asp:TextBox ID="txtCliente" runat="server" Enabled="False" style="margin-left: 0px" CssClass="form-control" Width="150px" Height="23px"></asp:TextBox>
                <br />

                <asp:Label ID="lblPago" runat="server" Text="Forma de pago:" ForeColor="#FF3300"></asp:Label>
                <asp:TextBox ID="txtFormaPago" runat="server" Enabled="False" style="margin-left: 0px" CssClass="form-control" Width="150px" Height="23px"></asp:TextBox>
                <br />
            </td>
        </tr>
    </table>
